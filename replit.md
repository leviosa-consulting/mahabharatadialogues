...
This is a Next.js 15.5.12 application for "Mahabharata Dialogues" - a platform that hosts retreats, events, blogs, and educational content related to the Mahabharata epic. The application serves both public-facing content pages and an admin dashboard for content management.
