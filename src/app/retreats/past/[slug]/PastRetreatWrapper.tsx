...
import PastRetreatClient from './PastRetreatClient.tsx'

export default function PastRetreatWrapper() {
  ...
  return <PastRetreatClient retreat={retreat} testimonials={testimonials} />
}
